...
(function(d) {
    ...
    for (
      var c = [],
        ...
        f = function(a, b) {
          ...
          if (d.isArray(a) || a instanceof d) for (g = 0, k = a.length; g < k; g++) f(a[g], b);
          else if (null === a || a === l || '*' === a)
            for (g = 0, k = h.length; g < k; g++) c.push({ inst: b, node: h[g].node });
            ...
            'object' === typeof a &&
              a.nodeName &&
              ((h = d.inArray(a, g)), -1 !== h && c.push({ inst: b, node: g[h] }));
        },
        h = 0,
        k = a.length;
      h < k;
    ...
    collection: {
      ...
      action: function(a, b, c, e) {
        ...
        e._collection.prepend(
          '<div class="dt-button-collection-title">' + e.collectionTitle + '</div>'
        );
        e._collection
        ...
        if (k && 'absolute' === f) e._collection.css({ top: k.top, left: k.left });
        else if ('absolute' === f) {
  ...
  g.Api.register('button().add()', function(a, b) {
    var c = this.context;
    c.length &&
      ((c = r.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a));
  ...
  g.Api.register('buttons.exportInfo()', function(a) {
    ...
    var b = a;
    var c =
      '*' === b.filename && '*' !== b.title && b.title !== l && null !== b.title && '' !== b.title
        ? b.title
        : b.filename;
