...
var AboutInnovationsComponent = /** @class */ (function () {
    function AboutInnovationsComponent() {
    }
    AboutInnovationsComponent.prototype.ngOnInit = function () {
    };
    ...
    return AboutInnovationsComponent;
}());
...
var TheTeamComponent = /** @class */ (function () {
    function TheTeamComponent(fireService) {
        this.fireService = fireService;
    }
    TheTeamComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.fireService.memberUtils.getMembers()];
                    case 1:
    ...
    TheTeamComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] }
    ]; };
...
var TeamDialogComponent = /** @class */ (function () {
    function TeamDialogComponent(matDialogData, dialogRef, fireService, imageService, toastrService) {
    ...
    TeamDialogComponent.prototype.onFileChange = function (event) {
        this.memberAvatar = event.target.files;
        if (this.memberAvatar) {
            this.teamMemberFG.get('avatarUrl').setValue('valid');
        }
    };
    TeamDialogComponent.prototype.saveMember = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var imageUrl, e_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.uploading = true;
                        return [4 /*yield*/, this.imageService.uploadSingle(this.memberAvatar, 'team')];
                    case 1:
                        imageUrl = _a.sent();
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.fireService.memberUtils.addMember(this.teamMemberFG.value)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
    ...
    TeamDialogComponent.prototype.ngOnInit = function () {
        var _this = this;
        _tools_services_config_service__WEBPACK_IMPORTED_MODULE_6__["config"].objectSchemas.teamMember.map(function (inputFields) {
            _this.teamMemberFG.registerControl(inputFields.key, _this.fb.control('', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]));
        });
    };
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(authService, dialog, fireService) {
    ...
    AdminComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fireService.initCategories()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AdminComponent.prototype.showAddProductDialog = function (type) {
        var dialogConfig = {
            width: '900px',
    ...
    AdminComponent.prototype.showMemberDialog = function () {
        var dialogConfig = {
            width: '600px',
            closeOnNavigation: true,
            hasBackdrop: true,
...
/* harmony import */ var angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! angular-bootstrap-md */ "./node_modules/angular-bootstrap-md/fesm5/angular-bootstrap-md.js");
...
var AddAwardsComponent = /** @class */ (function () {
    function AddAwardsComponent(imgService, db) {
        var _this = this;
        this.imgService = imgService;
        this.db = db;
        this.preventEdit = this.imgService.preventEdit;
        this.startUpload = function (files) {
            _this.imgService.prepToUploadSingle(files, 'awards').then(function (taskSnap) {
                taskSnap.ref.getDownloadURL().then(function (imgUlr) {
                    _this.image = imgUlr;
                    _this.imgService.preventEdit = false;
                });
            });
        };
        this.saveAwardElement = function (formData) {
            formData.image = _this.image;
            _this.db.AdminUtils.addElement(formData, 'awards').then(function () {
                //todo
                // saved notification
                // clear Form
            });
    ...
    AddAwardsComponent.prototype.ngOnInit = function () { };
    AddAwardsComponent.ctorParameters = function () { return [
...
var AwardsControlsComponent = /** @class */ (function () {
    function AwardsControlsComponent() {
    }
    AwardsControlsComponent.prototype.ngOnInit = function () { };
    ...
    return AwardsControlsComponent;
}());
...
var EditAwardsComponent = /** @class */ (function () {
    function EditAwardsComponent(db, imgService) {
        var _this = this;
        this.db = db;
        this.imgService = imgService;
        this.elements = this.db.AdminUtils.getElements('awards');
        this.setElement = function (id, element) {
            _this.awardElementId = id;
            _this.awardElement = element;
        };
        this.deleteElement = function (elementId) {
            var confirm = window.confirm('Сигурни ли сте че искате да изтриете тази новина!');
            if (confirm) {
                window.document.getElementById(elementId).remove();
                return _this.db.AdminUtils.deleteElementById(elementId, 'awards');
            }
        };
        this.startUpload = function (files) {
            try {
                _this.imgService.images = [];
                _this.imgService.startUpload(files);
                _this.awardElement.image = _this.imgService.images;
            }
            catch (e) {
        ...
        this.editAwardElement = function (id, formData) {
            if (_this.imgService.images.length > 0) {
                formData.image = _this.imgService.images[0];
            }
            else {
                if (_this.awardElement.image)
                    formData.image = _this.awardElement.image;
            }
            return _this.db.AdminUtils.updateElementById(id, 'awards', formData);
        };
    }
    EditAwardsComponent.prototype.ngOnInit = function () { };
    EditAwardsComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] },
...
var AddHomeComponent = /** @class */ (function () {
    function AddHomeComponent(db) {
        var _this = this;
        this.db = db;
        this.saveHomeElement = function (formData) {
            _this.db.AdminUtils.addElement(formData, 'homeProducts');
        };
    }
    AddHomeComponent.prototype.ngOnInit = function () { };
    AddHomeComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] }
    ]; };
...
var EditHomeComponent = /** @class */ (function () {
    function EditHomeComponent(db) {
        var _this = this;
        this.db = db;
        this.elements = this.db.AdminUtils.getElements('homeProducts');
        this.setElement = function (id, element) {
            _this.homeElementId = id;
            _this.homeElement = element;
        };
        this.deleteElement = function (elementId) {
            var confirm = window.confirm('Сигурни ли сте че искате да изтриете този елемент');
            if (confirm) {
                window.document.getElementById(elementId).remove();
                return _this.db.AdminUtils.deleteElementById(elementId, 'homeProducts');
            }
        };
        this.editHomeElement = function (id, formData) {
            return _this.db.AdminUtils.updateElementById(id, 'homeProducts', formData);
        };
    }
    EditHomeComponent.prototype.scrollToElement = function ($element) {
        console.log($element);
    ...
    EditHomeComponent.prototype.ngOnInit = function () { };
    EditHomeComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] }
    ]; };
...
var HomeControlsComponent = /** @class */ (function () {
    function HomeControlsComponent() {
    }
    HomeControlsComponent.prototype.ngOnInit = function () { };
...
var MdbEditableTableComponent = /** @class */ (function () {
    function MdbEditableTableComponent(toastR, db) {
        this.toastR = toastR;
        this.db = db;
        this.changeExist = false;
    }
    MdbEditableTableComponent.prototype.updateList = function (id, property, event) {
        var _this = this;
        ...
        if (this.changeExist) {
            ...
            this.db.PloughUtils.updatePlough(val, this.category, this.set, id)
                .then(function () {
                _this.collection[id][property] = editField;
                _this.changeExist = false;
                _this.updatedRow.removeAttribute('style');
                _this.toastR.success(property.toUpperCase() + ": " + editField, 'Saved!');
            })
                .catch(function (e) { return console.log(e.message); });
        }
    };
    MdbEditableTableComponent.prototype.remove = function (id) {
        var _this = this;
        if (window.confirm('Сигурни ли сте че искате да изтриете този продукт?'))
            this.db.PloughUtils.deletePlough(this.category, this.set, id)
                .then(function () {
                _this.toastR.info('Item Deleted!');
                delete _this.collection[id];
                document.getElementById(id).remove();
            })
                .catch(function (e) { return console.log(e.message); });
    };
    MdbEditableTableComponent.prototype.changeValue = function (event, id) {
    ...
    MdbEditableTableComponent.ctorParameters = function () { return [
    ...
    return MdbEditableTableComponent;
}());
...
var AddNewsComponent = /** @class */ (function () {
    function AddNewsComponent(imgService, db) {
        var _this = this;
        this.imgService = imgService;
        this.db = db;
        ...
        this.preventEdit = this.imgService.preventEdit;
        this.startUpload = function (files) {
            _this.imgService.prepToUploadSingle(files, 'news').then(function (taskSnap) {
                taskSnap.ref.getDownloadURL().then(function (imgUlr) {
                    _this.image = imgUlr;
                    _this.imgService.preventEdit = false;
                });
        ...
        this.saveNewsElement = function (formData) {
            formData.timeStamp = Date.now();
            formData.image = _this.image;
            _this.db.AdminUtils.addElement(formData, 'news').then(function () {
                //todo
                // saved notification
                // clear Form
            });
...
var EditNewsComponent = /** @class */ (function () {
    function EditNewsComponent(db, imgService) {
        var _this = this;
        this.db = db;
        this.imgService = imgService;
        this.elements = this.db.AdminUtils.getElements('news');
        this.setElement = function (id, element) {
            _this.newsElementId = id;
            _this.newsElement = element;
        };
        this.deleteElement = function (elementId) {
            var confirm = window.confirm('Сигурни ли сте че искате да изтриете тази новина!');
            if (confirm) {
                window.document.getElementById(elementId).remove();
                return _this.db.AdminUtils.deleteElementById(elementId, 'news');
            }
        };
        this.startUpload = function (files) {
            try {
                _this.imgService.images = [];
                _this.imgService.startUpload(files);
                _this.newsElement.image = _this.imgService.images;
            }
            catch (e) {
                console.log(e.message);
                _this.imgService.preventEdit = false;
        ...
        this.editNewsElement = function (id, formData) {
            if (_this.imgService.images.length > 0) {
                formData.image = _this.imgService.images[0];
            }
            else {
                if (_this.newsElement.image)
                    formData.image = _this.newsElement.image;
            }
            return _this.db.AdminUtils.updateElementById(id, 'news', formData);
        };
    }
    EditNewsComponent.prototype.ngOnInit = function () { };
    EditNewsComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] },
        { type: _tools_services_image_service__WEBPACK_IMPORTED_MODULE_3__["ImageService"] }
    ]; };
...
var NewsControlComponent = /** @class */ (function () {
    function NewsControlComponent() {
    }
    NewsControlComponent.prototype.ngOnInit = function () { };
...
var AddCategoryComponent = /** @class */ (function () {
    function AddCategoryComponent(db, imgService) {
        var _this = this;
        this.db = db;
        this.imgService = imgService;
        this.images = this.imgService.images;
        this.change = function (selectValue) {
            _this.category = selectValue;
        };
        this.addPloughCategory = function (categoryDetails) {
            categoryDetails.value.image = _this.images;
            return _this.db.addPloughCategory(_this.category, categoryDetails.value);
        };
        this.startUpload = function (event) { return _this.imgService.startUpload(event); };
    }
    AddCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.db.getType('ploughs').subscribe(function (response) {
            _this.categories = Object.keys(response['types']);
...
var AddPloughComponent = /** @class */ (function () {
    function AddPloughComponent(db, imgService, toastr) {
        var _this = this;
        this.db = db;
        this.imgService = imgService;
        this.toastr = toastr;
        this.images = this.imgService.images;
        this.onCategoryChange = function (selectValue) {
            _this.category = selectValue;
            _this.db.getSubCategories('ploughs', selectValue).subscribe(function (data) {
                _this.subCategory = Object.keys(data)[0];
                _this.subCategories = Object.keys(data);
            });
        };
        this.onSubCategoryChange = function (selectValue) {
            _this.subCategory = selectValue;
        };
        this.savePlough = function (data, category) {
            data.image = _this.images;
            _this.db.PloughUtils.addPlough(data, category, _this.subCategory)
                .then(function () {
                _this.toastr.success('Добавен');
            })
                .catch(function (e) {
                console.log(e);
            });
    ...
    AddPloughComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.db.getType('ploughs/types').subscribe(function (data) {
            _this.category = Object.keys(data)[0];
            _this.categories = Object.keys(data);
            _this.db.getSubCategories('ploughs', _this.category).subscribe(function (data) {
                _this.subCategory = Object.keys(data)[0];
                _this.subCategories = Object.keys(data);
            });
        });
    };
    AddPloughComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] },
        { type: _tools_services_image_service__WEBPACK_IMPORTED_MODULE_3__["ImageService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] }
    ]; };
...
var EditPloughsComponent = /** @class */ (function () {
    function EditPloughsComponent(db) {
        var _this = this;
        this.db = db;
        this.onCategoryChange = function (selectValue) {
            _this.set = null;
            _this.series = null;
            _this.ploughList = null;
            _this.category = selectValue;
            _this.db.getType('ploughs/types/' + selectValue).subscribe(function (res) {
                _this.data = res['series'];
                _this.series = Object.keys(res['series']);
            });
        };
        this.onSetChange = function (selectValue) {
            _this.set = selectValue;
            _this.setData = _this.data[_this.set];
            _this.ploughList = _this.data[selectValue]['collection'];
        };
    }
    EditPloughsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.db.getType("ploughs").subscribe(function (res) {
            _this.categories = Object.keys(res.types);
        });
    };
    EditPloughsComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] }
    ]; };
...
var PloughControlsComponent = /** @class */ (function () {
    function PloughControlsComponent() {
    }
    PloughControlsComponent.prototype.ngOnInit = function () { };
    ...
    return PloughControlsComponent;
}());
...
var AddProjectsComponent = /** @class */ (function () {
    function AddProjectsComponent(imgService, db) {
        var _this = this;
        this.imgService = imgService;
        this.db = db;
        this.preventEdit = this.imgService.preventEdit;
        this.startUpload = function (files) {
            _this.imgService.prepToUploadSingle(files, 'projects').then(function (taskSnap) {
                taskSnap.ref.getDownloadURL().then(function (imgUlr) {
                    _this.image = imgUlr;
                    _this.imgService.preventEdit = false;
                });
        ...
        this.saveProjectElement = function (formData) {
            if (_this.image) {
                formData.image = _this.image;
            }
            else {
            ...
            _this.db.AdminUtils.addElement(formData, 'projects').then(function () {
                //todo
                // saved notification
                // clear Form
            });
...
var EditProjectsComponent = /** @class */ (function () {
    function EditProjectsComponent(db, imgService) {
        var _this = this;
        this.db = db;
        this.imgService = imgService;
        this.elements = this.db.AdminUtils.getElements('projects');
        this.setElement = function (id, element) {
            _this.projectElementId = id;
            _this.projectElement = element;
        };
        this.deleteElement = function (elementId) {
            var confirm = window.confirm('Сигурни ли сте че искате да изтриете тази новина!');
            if (confirm) {
                window.document.getElementById(elementId).remove();
                return _this.db.AdminUtils.deleteElementById(elementId, 'projects');
            }
        };
        this.startUpload = function (files) {
            try {
                _this.imgService.images = [];
                _this.imgService.startUpload(files);
                _this.projectElement.image = _this.imgService.images;
            }
            catch (e) {
                console.log(e.message);
                _this.imgService.preventEdit = false;
        ...
        this.editProjectElement = function (id, formData) {
            if (_this.imgService.images.length > 0) {
                formData.image = _this.imgService.images[0];
            }
            else {
                if (_this.projectElement.image)
                    formData.image = _this.projectElement.image;
            }
            return _this.db.AdminUtils.updateElementById(id, 'projects', formData);
        };
    }
...
var ProjectsControlComponent = /** @class */ (function () {
    function ProjectsControlComponent() {
    }
    ProjectsControlComponent.prototype.ngOnInit = function () { };
    ...
    return ProjectsControlComponent;
}());
...
var ProductAddDialog = /** @class */ (function () {
    function ProductAddDialog(matDialogData, dialogRef, fireService, toastrService) {
        this.matDialogData = matDialogData;
        this.dialogRef = dialogRef;
        this.fireService = fireService;
        this.toastrService = toastrService;
    ...
    ProductAddDialog.prototype.initProductFormGroup = function (productType) {
        var _this = this;
        var fg = this.fb.group({});
        this.headers[productType].map(function (prop) {
            fg.addControl(prop.key, _this.fb.control('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]));
        });
        return fg;
    };
    ProductAddDialog.prototype.initProductTypeSelectFormControl = function (initialType) {
        return this.fb.control(initialType, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]);
    };
    ProductAddDialog.prototype.initSeriesSelectFormControl = function (productType, newSeries) {
    ...
    ProductAddDialog.prototype.closeDialog = function () {
        this.dialogRef.close();
    };
    ProductAddDialog.prototype.saveProduct = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var productData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productData = this.productFormGroup.value;
                        return [4 /*yield*/, this.fireService.addItem(productData, this.matDialogData.type, this.selectTypeFormControl.value, this.selectSeriesFormControl.value)];
                    case 1:
                        _a.sent();
    ...
    ProductAddDialog.prototype.ngOnInit = function () {
        var _this = this;
        var productType = this.matDialogData.type;
        ...
        if (this.types) {
            ...
            this.selectTypeFormControl.valueChanges.subscribe(function (selectedType) {
                _this.selectSeriesFormControl = _this.initSeriesSelectFormControl(productType, selectedType);
            });
        }
    };
    ProductAddDialog.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(db, activeRoute) {
        this.db = db;
...
var CategoryOverviewComponent = /** @class */ (function () {
    function CategoryOverviewComponent(activeRoute, db) {
        this.activeRoute = activeRoute;
        this.db = db;
    }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.db.getSubCategories(params.type, params.category).toPromise()];
                    case 1:
                        _a.data = _b.sent();
    ...
    CategoryOverviewComponent.ctorParameters = function () { return [
...
var CategoryComponent = /** @class */ (function () {
    function CategoryComponent(db) {
        this.db = db;
        //todo FIX TYPE!
    }
    CategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.db.getType(this.category).subscribe(function (response) {
            _this.data = response;
            debugger;
            _this.categories = Object.keys(response['types']);
        });
...
var CultivatorsComponent = /** @class */ (function () {
    function CultivatorsComponent() {
    }
    CultivatorsComponent.prototype.ngOnInit = function () {
...
var DisksComponent = /** @class */ (function () {
    function DisksComponent() {
    }
...
var MdbAccordionComponent = /** @class */ (function () {
    function MdbAccordionComponent() {
        this.multiple = true;
    }
    MdbAccordionComponent.prototype.ngOnInit = function () {
...
var PloughsComponent = /** @class */ (function () {
    function PloughsComponent() {
    }
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(route, db) {
        this.route = route;
        this.db = db;
    }
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.db.getCatalog()];
                    case 1:
                        _a.catalog = _b.sent();
                        return [2 /*return*/];
                }
...
/* harmony import */ var angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! angular-bootstrap-md */ "./node_modules/angular-bootstrap-md/fesm5/angular-bootstrap-md.js");
/* harmony import */ var _tools_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../tools/pipes/pipes.module */ "./src/app/tools/pipes/pipes.module.ts");
...
var RippersComponent = /** @class */ (function () {
    function RippersComponent() {
    }
    RippersComponent.prototype.ngOnInit = function () {
...
var RollersComponent = /** @class */ (function () {
    function RollersComponent() {
    }
    RollersComponent.prototype.ngOnInit = function () {
...
var ShreddersComponent = /** @class */ (function () {
    function ShreddersComponent() {
    }
    ShreddersComponent.prototype.ngOnInit = function () {
...
var SubcategoryComponent = /** @class */ (function () {
    function SubcategoryComponent(activeRoute, db) {
        this.activeRoute = activeRoute;
        this.db = db;
    }
    SubcategoryComponent.prototype.ngOnInit = function () {
        ...
        this.db.getseriesData(this.type, this.category, this.subCategory).subscribe(function (data) {
            _this.data = data;
        });
    };
...
var MdbCarouselComponent = /** @class */ (function () {
    function MdbCarouselComponent() {
        this.isArray = function (val) { return Array.isArray(val); };
        this.onRightClick = function () {
            return false;
        };
    }
    MdbCarouselComponent.prototype.ngOnInit = function () { };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
...
var MdbFooterComponent = /** @class */ (function () {
    function MdbFooterComponent() {
    }
...
var MdbJumbotronComponent = /** @class */ (function () {
    function MdbJumbotronComponent() {
    }
    MdbJumbotronComponent.prototype.ngOnInit = function () { };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
...
var MdbNewsComponent = /** @class */ (function () {
    function MdbNewsComponent(db) {
        this.db = db;
    }
    MdbNewsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.db.AdminUtils.getElements('news').subscribe(function (res) {
            _this.news = Object.values(res).sort(function (a, b) { return b.timeStamp - a.timeStamp; });
            _this.latestNewsElement = _this.news.shift();
        });
    };
    MdbNewsComponent.ctorParameters = function () { return [
        { type: _tools_services_fire_service__WEBPACK_IMPORTED_MODULE_2__["FireService"] }
    ]; };
...
var MdbSectionComponent = /** @class */ (function () {
    function MdbSectionComponent() {
    }
    Object.defineProperty(MdbSectionComponent.prototype, "left", {
        get: function () {
            return this._left;
        },
    ...
    MdbSectionComponent.prototype.ngOnInit = function () {
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(fireService) {
        this.fireService = fireService;
    }
...
var ProductTableCultivatorsHeadersComponent = /** @class */ (function () {
    function ProductTableCultivatorsHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTableCultivatorsHeadersComponent;
}());
...
var ProductTableDisksHeadersComponent = /** @class */ (function () {
    function ProductTableDisksHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTableDisksHeadersComponent;
}());
...
var ProductTablePloughsHeadersComponent = /** @class */ (function () {
    function ProductTablePloughsHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTablePloughsHeadersComponent;
}());
...
var ProductTableRollersHeadersComponent = /** @class */ (function () {
    function ProductTableRollersHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTableRollersHeadersComponent;
}());
...
var ProductTableShreddersHeadersComponent = /** @class */ (function () {
    function ProductTableShreddersHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTableShreddersHeadersComponent;
}());
...
var ProductTableSprayersHeadersComponent = /** @class */ (function () {
    function ProductTableSprayersHeadersComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ...
    return ProductTableSprayersHeadersComponent;
}());
...
var applicationRouting = [{ path: '**', redirectTo: 'home', pathMatch: 'full' }];
...
var ArraySortPipe = /** @class */ (function () {
    ...
    ArraySortPipe.prototype.transform = function (obj, field) {
        Object.values(obj).sort(function (a, b) {
            if (a[field] < b[field]) {
                return -1;
            }
...
var objectSplitToArray = /** @class */ (function () {
    function objectSplitToArray() {
    }
    objectSplitToArray.prototype.transform = function (obj, chunks) {
        if (!obj)
            return;
...
var AuthService = /** @class */ (function () {
    function AuthService(toastR, firebaseAuth) {
        this.toastR = toastR;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().setPersistence(persistence)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.firebaseAuth.auth.signInWithPopup(this.oAuthProvider)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
...
var FireService = /** @class */ (function () {
    function FireService(auth, db, http, toastrService) {
        var _this = this;
        this.auth = auth;
        this.db = db;
        this.http = http;
        ...
        this.memberUtils = {
            addMember: function (memberData) { return _this.db.database.ref('team').push(memberData); },
            getMembers: function () { return _this.http.get(_this.databaseUrl + "/team.json").toPromise(); }
        };
        this.AdminUtils = {
            addElement: function (data, dbLocation) {
            ...
            getElements: function (elementType) { return _this.http.get(_this.databaseUrl + "/" + elementType + ".json"); },
            deleteElementById: function (id, elementType) {
                return _this.db.database
                    .ref(elementType + "/" + id)
                    .remove()
                    .then(function () {
            ...
            updateElementById: function (id, elementType, newValue) {
                return _this.db.database
                    .ref(elementType + "/" + id)
                    .update(newValue)
                    .then(function () {
        ...
        this.PloughUtils = {
            getPlough: function (category, series, id) {
                return _this.getSingleItem('ploughs', category, series, id);
            },
            getPloughSubcategories: function (category) {
                return _this.getSubCategories('ploughs', category);
            },
            getPloughTypes: function () { return _this.getType('ploughs'); },
            deletePlough: function (category, series, id) {
                return _this.removeItem('ploughs', category, series, id);
            },
            addPlough: function (data, category, series) {
                return _this.addItem(data, 'ploughs', category, series);
            },
            updatePlough: function (data, category, series, id) {
                return _this.updateItem(data, 'ploughs', category, series, id);
            },
            getCategorySet: function (category, series) {
                return _this.http.get(_this.databaseUrl + "/ploughs/types/" + category + "/series/" + series + ".json");
            },
        };
        this.ProductUtils = {
            getProduct: function (product, category, series, id) { return _this.getSingleItem(product, category, series, id); },
            addItem: function (product, data, category, series) {
                return _this.addItem(data, product, category, series);
            },
            getPloughSubcategories: function (category) {
                return _this.getSubCategories('ploughs', category);
            },
        ...
        this.getSingleItem = function (type, category, series, id) {
            return _this.http.get((_this.databaseUrl + "/" + type + "/types/" + category + "/series/" + series + "/collection/").toLocaleLowerCase() + (id + ".json"));
        };
        this.getType = function (type) { return _this.http.get(_this.databaseUrl + "/" + type + ".json"); };
        this.getSubCategories = function (type, category) {
            return _this.http.get(_this.databaseUrl + "/" + type + "/types/" + category + "/series.json");
        };
        this.getseriesData = function (type, category, series) {
            return _this.http.get((_this.databaseUrl + "/" + type + "/types/" + category + "/series/" + series + "/collection.json").toLocaleLowerCase());
        };
        this.addItem = function (data, productType, type, series) {
            return _this.db.database.ref(productType + "/types/" + type + "/series/" + series + "/collection").push(data);
        };
        this.addPloughCategory = function (type, categoryDetails) {
            return _this.db.database
        ...
        this.updateItem = function (data, type, category, series, id) {
            return _this.db.database
                .ref(type + "/types/" + category + "/series/" + series + "/collection/" + id)
                .update(data);
        };
        this.removeItem = function (type, category, series, id) {
            return _this.db.database.ref(type + "/types/" + category + "/series/" + series + "/collection/" + id).remove();
        };
    ...
    FireService.prototype.networkStatus = function () {
        var _this = this;
        this.online.subscribe(function (status) {
            if (!status) {
                _this.toastrService.info('Lost internet connection');
            }
            _this.internetStatus = status;
        });
    };
    FireService.prototype.initCategories = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, products, newObj;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        products = Object.keys(_config_service__WEBPACK_IMPORTED_MODULE_7__["config"].headers);
                        newObj = {};
                        products.map(function (productType) {
                            newObj[productType] = _this.DATABASE[productType];
                        });
    ...
    FireService.prototype.initDB = function () {
        return this.http.get(this.databaseUrl + "/.json").toPromise();
    };
    FireService.prototype.getCatalog = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var cat;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                cat = {};
                Object.keys(_config_service__WEBPACK_IMPORTED_MODULE_7__["config"].headers).map(function (productType) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var _a, _b, _c, _d;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                ...
                                _b = productType;
                                _d = (_c = Object).keys;
                                return [4 /*yield*/, this.http.get(this.databaseUrl + "/" + productType + "/types.json").toPromise()];
                            case 1:
...
var ImageService = /** @class */ (function () {
    function ImageService(auth, http, storage) {
        var _this = this;
        this.auth = auth;
        this.http = http;
        ...
        this.startUpload = function (event) {
            _this.status = 'Uploading please wait!';
            _this.disableFileUpload();
            // The File object
            for (var i = 0; i < event.length; i++) {
                ...
                var path = "images/" + date + "_" + file.name;
                //Upload To StorageAsFile
                _this.task = _this.storage.upload(path, file);
                //Get link to uploaded file and upload it userCollection in DB
                _this.task.then(function (data) {
                    data.ref
                        .getDownloadURL()
        ...
        this.prepToUploadSingle = function (event, location) {
            var file = event.item(0);
            _this.preventEdit = true;
            if (file.type.split('/')[0] !== 'image') {
                _this.preventEdit = false;
                throw new TypeError('Unsupported File Type!');
            }
            var date = new Date().getTime();
            var path = location + "/" + date + "_" + file.name;
            return _this.storage.upload(path, file);
        };
    }
    ImageService.prototype.uploadSingle = function (files, path) {
        if (path === void 0) { path = 'images'; }
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var image, imageUrl, imageName;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        imageName = new Date().getTime() + "_" + image.name;
                        this.task = this.storage.upload(path + "/" + imageName, image);
                        return [4 /*yield*/, this.task.then(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, data.ref.getDownloadURL()];
