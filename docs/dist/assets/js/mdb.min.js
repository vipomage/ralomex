...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function(t, e, i, n, a) {
      ...
      return e < 1
        ...
        : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * a - r) * (2 * Math.PI)) / o) * 0.5 +
            n +
            i;
    },
          ...
          (i.isWindow = function(t) {
            ...
            (i.extend = function() {
              var t,
                ...
                d = !1;
              for (
                'boolean' == typeof s && ((d = s), (s = arguments[l] || {}), l++),
            ...
            (i.fn = i.prototype = {
              ...
              offset: function() {
                ...
                return {
                  top:
                    e.top + (t.pageYOffset || document.scrollTop || 0) - (document.clientTop || 0),
                  left:
                    e.left +
        ...
        return (function(t, e, i, n) {
          ...
          function s(t, e) {
            ...
            return (
              ...
              !1 === i && (i = v.Easings[v.defaults.easing] ? v.defaults.easing : m),
              i
            );
          }
          function l(t) {
              ...
              for (var a = 0; i > a; a++)
                if (v.State.calls[a]) {
                  ...
                  for (var m = Math.min((e - h) / c.duration, 1), b = 0, x = s.length; x > b; b++) {
                    ...
                    if (r(S)) {
                        ...
                        if ('element' !== M) {
                          ...
                          if (((T.currentValue = P), 'tween' === M)) g = P;
                            ...
                            var F = y.setPropertyValue(
                              S,
                              M,
                              T.currentValue + (0 === parseFloat(P) ? '' : T.unitType),
                              T.rootPropertyValue,
                              T.scrollData
                            );
                      ...
                      c.mobileHA &&
                        ...
                        ((r(S).transformCache.translate3d = '(0px, 0px, 0px)'), (C = !0)),
                  ...
                  c.display !== n && 'none' !== c.display && (v.State.calls[a][2].display = !1),
                    ...
                    c.progress &&
                      c.progress.call(o[1], o[1], m, Math.max(0, h + c.duration - e), h, g),
                    1 === m && u(a);
                }
            }
          ...
          function u(t, e) {
            ...
            for (
              ...
              if (
                (e ||
                  o.loop ||
                  ('none' === o.display && y.setPropertyValue(h, 'display', o.display),
                  'hidden' === o.visibility && y.setPropertyValue(h, 'visibility', o.visibility)),
                !0 !== o.loop &&
          ...
          var d,
            ...
            p = !1;
          if (
            (t.fn && t.fn.jquery ? ((d = t), (p = !0)) : (d = e.Velocity.Utilities), 8 >= c && !p)
          )
              ...
              return function t(e, n, a) {
                ...
                for (
                  e = parseFloat(e) || 500,
                    ...
                    l.tension = e,
                    l.friction = n,
                    (r = null !== a) ? (o = ((d = t(e, n)) / a) * 0.016) : (o = 0.016);
                  (s = i(s || l, o)),
                    u.push(1 + s.x),
                    (d += 16),
            ...
            var y = (v.CSS = {
                      ...
                      y.Normalizations.registered[e] = function(t, i, a) {
                        switch (t) {
                          ...
                          case 'inject':
                            ...
                            return (
                              o || (r(i).transformCache[e] = '(' + a + ')'), r(i).transformCache[e]
                            );
                        }
                      };
                    })();
              ...
              Names: {
                ...
                SVGAttribute: function(t) {
                  ...
                  return (
                    (c || (v.State.isAndroid && !v.State.isChrome)) && (e += '|transform'),
              ...
              getPropertyValue: function(t, i, a, o) {
                function s(t, i) {
                  ...
                  if (8 >= c) l = d.css(t, i);
                    ...
                    (u =
                      ...
                      ('' === (l = 9 === c && 'filter' === i ? u.getPropertyValue(i) : u[i]) ||
                        null === l) &&
                        (l = t.style[i]),
                      a();
                  }
                ...
                if (y.Hooks.registered[i]) {
                  ...
                  var f, p;
                  'transform' !== (f = y.Normalizations.registered[i]('name', t)) &&
              ...
              function o() {
                  ...
                  function g() {
                    ...
                    if (a && n)
                      ...
                      v.init(u),
                        ...
                        (l.percentToPxWidth = L.lastPercentToPxWidth =
                          (parseFloat(y.getPropertyValue(u, 'width', null, !0)) || 1) / s),
                        (l.percentToPxHeight = L.lastPercentToPxHeight =
                          (parseFloat(y.getPropertyValue(u, 'height', null, !0)) || 1) / s),
                        (l.emToPx = L.lastEmToPx =
                          (parseFloat(y.getPropertyValue(u, 'paddingLeft')) || 1) / s),
                        t.myParent.removeChild(u);
                    }
                    return (
                      null === L.remToPx &&
                        (L.remToPx = parseFloat(y.getPropertyValue(i.body, 'fontSize')) || 16),
                      null === L.vwToPx &&
                  ...
                  if ('scroll' === P) {
                    ...
                    u.container
                      ? f.isWrapped(u.container) || f.isNode(u.container)
                        ? ((u.container = u.container[0] || u.container),
                          (M =
                            (x = u.container['scroll' + A]) + d(o).position()[A.toLowerCase()] + _))
                        : (u.container = null)
                      : ((x = v.State.scrollAnchor[v.State['scrollProperty' + A]]),
                        (k =
                          v.State.scrollAnchor[
                            v.State['scrollProperty' + ('Left' === A ? 'Top' : 'Left')]
                          ]),
                    ...
                    for (var D in I)
                      if ('element' !== D) {
                        ...
                        (I[D].startValue = I[D].currentValue = I[D].endValue),
                          ...
                          v.debug &&
                            console.log(
                              'reverse tweensContainer (' + D + '): ' + JSON.stringify(I[D]),
                              o
                            );
                      }
                    c = I;
                    ...
                    b)) {
                      ...
                      if (
                        ...
                        ((u.display !== n && null !== u.display && 'none' !== u.display) ||
                        ...
                        if (
                          ((E = (H = p(O, E))[0]),
                          (q = H[1]),
                          (z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function(t, e) {
                            return (Y = e), '';
                          })),
                          (j = H[1]),
                          (E = parseFloat(E) || 0),
                          ...
                          '%' === j &&
                            (/^(fontSize|lineHeight)$/.test(O)
                              ...
                              : /^scale/.test(O)
                              ? ((z /= 100), (j = ''))
                              : /(Red|Green|Blue)$/i.test(O) && ((z = (z / 100) * 255), (j = ''))),
                          /[\/*]/.test(Y))
                        )
                          j = q;
                        else if (q !== j && 0 !== E)
                          if (0 === z) j = q;
                            ...
                            a = a || g();
                            var U =
                              /margin|padding|left|right|width|text|word|letter/i.test(O) ||
                              /X$/.test(O) ||
                              'x' === O
                                ? 'x'
                                : 'y';
                        ...
                        (c[O] = {
                          ...
                          v.debug &&
                            console.log('tweensContainer (' + O + '): ' + JSON.stringify(c[O]), o);
                      } else
                        v.debug &&
                ...
                !1 !== v.mock &&
                  ...
                  u.display !== n &&
                    ...
                    'auto' === u.display && (u.display = v.CSS.Values.getDisplayType(o))),
                  u.visibility !== n &&
                    null !== u.visibility &&
                          ...
                          d.each(e[1], function(i, a) {
                            ...
                            return (
                              ...
                              void d.each(m, function(i, n) {
                                n === a &&
                                  ((!0 === w || f.isString(w)) &&
                                    (d.each(d.queue(n, f.isString(w) ? w : ''), function(t, e) {
                                  ...
                                  'stop' === b
                                    ? (r(n) &&
                                        r(n).tweensContainer &&
                                        !1 !== o &&
                                        d.each(r(n).tweensContainer, function(t, e) {
                    ...
                    if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                      if (f.isString(b) && v.Redirects[b]) {
                        var _ = (O = d.extend({}, w)).duration,
                          I = O.delay || 0;
                        return (
                          !0 === O.backwards && (m = d.extend(!0, [], m).reverse()),
                          d.each(m, function(t, e) {
                            parseFloat(O.stagger)
                              ...
                              O.drag &&
                                ((O.duration =
                                  parseFloat(_) || (/^(callout|transition)/.test(b) ? 1e3 : g)),
                                (O.duration = Math.max(
                                  O.duration * (O.backwards ? 1 - t / S : (t + 1) / S),
                                  0.75 * O.duration,
                                  200
                                ))),
                              v.Redirects[b].call(e, e, O || {}, t, S, m, T.promise ? T : n);
                          }),
                          t()
                        );
                      }
          ...
          function(t, e, i) {
            ...
            (r.prototype = {
              ...
              (r.prototype.setValues = function(t, e) {
                ...
                if (
                  ((r.alpha = Math.max(0, Math.min(1, void 0 === l ? r.alpha : l))), 'alpha' === t)
                )
                  return !1;
          ...
          function(t, e, i) {
            ...
            for (var r in n) {
              a[r + 'Raw'] = (function(t) {
                return function(e) {
                  return (
                    'number' == typeof e && (e = Array.prototype.slice.call(arguments)), n[t](e)
                  );
                };
              })(r);
              var o = /(\w+)2(\w+)/.exec(r),
              ...
              (e.exports = function(t) {
                t.controllers.bubble = t.DatasetController.extend({
                  ...
                  _resolveElementOptions: function(t, e) {
                    ...
                    return (
                      (h.radius = d([l.radius, c ? c.r : void 0, s.radius, u.radius], f, e)), h
                    );
                  },
                });
              });
              ...
              (e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                  ...
                  getPointRotation: function(t, e) {
                    ...
                    return (
                      isNaN(a.rotation)
                        ? (isNaN(n.pointRotation) && !r.isArray(n.pointRotation)) ||
                  ...
                  updateElement: function(t, e, i) {
                    ...
                    void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                      ...
                      (t._model = {
                        ...
                        pointStyle:
                          l.pointStyle || r.valueAtIndexOrDefault(u.pointStyle, e, p.pointStyle),
                        ...
                        hitRadius:
                          l.hitRadius || r.valueAtIndexOrDefault(u.pointHitRadius, e, p.hitRadius),
                      });
                  },
                ...
                o.extend(t.prototype, {
                  ...
                  updateDataset: function(t) {
                    ...
                    !1 !== d.notify(this, 'beforeDatasetUpdate', [i]) &&
                      (e.controller.update(), d.notify(this, 'afterDatasetUpdate', [i]));
                  },
                  render: function(t) {
                    var e = this;
                  ...
                  drawDataset: function(t, e) {
                    ...
                    !1 !== d.notify(this, 'beforeDatasetDraw', [n]) &&
                      (i.controller.draw(e), d.notify(this, 'afterDatasetDraw', [n]));
                  },
              ...
              (r.configMerge = function() {
                    ...
                    merger: function(t, e, i, n) {
                      if ('xAxes' === t || 'yAxes' === t) {
                        ...
                        for (e[t] || (e[t] = []), a = 0; a < u; ++a)
                          (l = i[t][a]),
                            (s = r.valueOrDefault(l.type, 'xAxes' === t ? 'category' : 'linear')),
                ...
                (r.getRelativePosition = function(t, e) {
                  ...
                  return {
                    ...
                    y: (n = Math.round(
                      (((n - s.top - d) / p) * o.height) / e.currentDevicePixelRatio
                    )),
                  };
                }),
                ...
                fit: function() {
                  ...
                  if (a.display && h) {
                    ...
                    if (f) {
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft = 'bottom' === n.position ? k * C + 3 : k * y + 3),
                ...
                _autoSkip: function(t) {
                  ...
                  for (
                    l.maxTicksLimit && (a = l.maxTicksLimit),
                      s &&
                        ((e = !1),
                        (h + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) &&
                          (e =
                            1 +
                            Math.floor(
                ...
                draw: function(t) {
                  ...
                  if (i.display) {
                    ...
                    if (
                        ...
                        if (!r.isNullOrUndef(n.label)) {
                          ...
                          a === e.zeroLineIndex && i.offset === h.offsetGridLines
                            ...
                            : ((u = r.valueAtIndexOrDefault(h.lineWidth, a)),
                              ...
                              (c = r.valueOrDefault(h.borderDash, o.borderDash)),
                              (f = r.valueOrDefault(h.borderDashOffset, o.borderDashOffset)));
                          var V = 'middle',
                            z = 'middle',
                            N = s.padding;
                          if (g) {
                      ...
                      r.each(P, function(t) {
                        if (
                          (h.display &&
                            ...
                            a.beginPath(),
                            h.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)),
                            h.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)),
                            a.stroke(),
                            a.restore()),
                          s.display)
                        ) {
                      ...
                      if (g)
                        (F = e.left + (e.right - e.left) / 2),
                          (O =
                            'bottom' === i.position ? e.bottom - R - C.bottom : e.top + R + C.top);
                      else {
                    ...
                    if (h.drawBorder) {
                      ...
                      g
                        ? ((E = W = 'top' === i.position ? e.bottom : e.top), (E += B), (W += B))
                        : ((z = N = 'left' === i.position ? e.right : e.left), (z += B), (N += B)),
                        a.beginPath(),
                        a.moveTo(z, E),
                        a.lineTo(N, W),
                        a.stroke();
            ...
            i = e.exports = {
              ...
              drawPoint: function(t, e, i, n, a, r) {
                ...
                if (
                  ...
                  if (!(isNaN(i) || i <= 0)) {
                    switch (
                      (t.save(), t.translate(n, a), t.rotate((r * Math.PI) / 180), t.beginPath(), e)
                    ) {
                      default:
            ...
            function g(t, e, i) {
              var u,
                ...
                m = (g.resizer = (function(t) {
                  ...
                  return (
                    h(a, 'scroll', s.bind(a, 'expand')), h(o, 'scroll', s.bind(o, 'shrink')), e
                  );
                })(
                  ((u = function() {
              ...
              draw: function() {
                ...
                if (e.display) {
                  ...
                  r.each(t.legendItems, function(n, l) {
                    ...
                    x
                      ? m + g >= s &&
                        ((v = d.y += w), d.line++, (m = d.x = t.left + (s - u[d.line]) / 2))
                      : v + w > t.bottom &&
                      ...
                      (function(t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
                          ...
                          if (
                            (c.setLineDash && c.setLineDash(h(n.lineDash, o.borderDash)),
            ...
            e.exports = function() {
              var t = n.extend({
                ...
                getPixelForValue: function(t, e) {
                  ...
                  if (
                    (void 0 !== t && null !== t && (i = n.isHorizontal() ? t.x : t.y),
                ...
                l =
                  ...
                  (function(t, e, i, n) {
                    ...
                    for (a = c.indexOf(t); a < s - 1; ++a)
                      if (
                        ((o = (r = d[c[a]]).steps ? r.steps[r.steps.length - 1] : u),
            ...
            e.exports = function() {
              var t = o.extend({
                ...
                buildTicks: function() {
                  ...
                  for (
                    'ticks' === s.bounds && u.length && ((r = u[0]), (o = u[u.length - 1])),
                      r = m(l.min, a) || r,
                      o = m(l.max, a) || o,
                      t = 0,
                      e = u.length;
                      ...
                      return (
                        a.offset &&
                          ...
                          (a.time.min ||
                            ((r = e.length > 1 ? e[1] : n),
                            (o = e[0]),
                            (s = (p(t, 'time', r, 'pos') - p(t, 'time', o, 'pos')) / 2)),
                          a.time.max ||
                            ((r = e[e.length - 1]),
  ...
  (function(t, e) {
    ...
    var l = {
        ...
        hide: function(t, e) {
          for (
            var i = (e = e || this).getElementsByClassName('waves-rippling'), a = 0, r = i.length;
            a < r;
            a++
          )
            d(t, e, i[a]);
