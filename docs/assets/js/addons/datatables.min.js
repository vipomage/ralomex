!(function(e) {
  ...
  'function' == typeof define && define.amd
    ...
    ? (module.exports = function(t, a) {
        return (
          t || (t = window),
          a || (a = 'undefined' != typeof window ? require('jquery') : require('jquery')(t)),
          e(a, t, t.document)
        );
      })
  ...
  function A(t) {
    ...
    e.each(t, function(e, l) {
      (r = e.match(/^([^A-Z]+?)([A-Z])/)),
        r &&
          -1 !== a.indexOf(r[1] + ' ') &&
          ((n = e.replace(r[0], r[2].toLowerCase())), (i[n] = e), 'o' === r[1] && A(t[e]));
    }),
      (t._hungarianMap = i);
  }
  function F(t, a, n) {
  ...
  function O(t, a, i) {
    ...
    (l._bAttrSrc = e.isPlainObject(f) && (h(f.sort) || h(f.type) || h(f.filter))),
      (l._setter = null),
    ...
    l.bSortable && (p || v)
      ? p && !v
        ? ((l.sSortingClass = o.sSortableAsc), (l.sSortingClassJUI = o.sSortJUIAscAllowed))
        : !p && v
        ? ((l.sSortingClass = o.sSortableDesc), (l.sSortingClassJUI = o.sSortJUIDescAllowed))
        ...
        e.iDrawError != i &&
          ...
          (ft(
            ...
            'Requested unknown parameter ' +
              ('function' == typeof l.mData ? '{function}' : "'" + l.mData + "'") +
              ' for row ' +
              t +
              ', column ' +
              a,
    ...
    if (null === l.nTr) {
      for (
        ...
        (c = t.aoColumns[d]),
          ...
          c.bVisible && !n ? u.appendChild(f) : !c.bVisible && n && f.parentNode.removeChild(f),
          c.fnCreatedCell && c.fnCreatedCell.call(t.oInstance, f, z(t, r, d), o, r, d);
    ...
    for (u && (i = e('<tr/>').appendTo(o)), a = 0, r = c.length; r > a; a++)
      (l = c[a]),
        ...
        t.oFeatures.bSort &&
          ...
          l.bSortable !== !1 &&
            (n.attr('tabindex', t.iTabIndex).attr('aria-controls', t.sTableId), nt(t, l.nTh, a))),
  ...
  function ce(t) {
    ...
    vt(t, 'aoHeaderCallback', 'header', [e(t.nTHead).children('tr')[0], ae(t), g, b, v]),
      vt(t, 'aoFooterCallback', 'footer', [e(t.nTFoot).children('tr')[0], ae(t), g, b, v]);
    var x = e(t.nTBody);
    x.children().detach(),
      x.append(e(o)),
    ...
    for (var u, f, c, d, h, p, s = t.sDom.split(''), v = 0; v < s.length; v++) {
      if (((u = null), (f = s[v]), '<' == f)) {
        if (((c = e('<div/>')[0]), (d = s[v + 1]), "'" == d || '"' == d)) {
          ...
          if (
            ('H' == h ? (h = a.sJUIHeader) : 'F' == h && (h = a.sJUIFooter), -1 != h.indexOf('.'))
          ) {
            var g = h.split('.');
  ...
  function We(t) {
    ...
    return (
      ...
      c.children().append(t.oLanguage.sLengthMenu.replace('_MENU_', s[0].outerHTML)),
      e('select', c)
  ...
  function Ve(t, a) {
    t.oFeatures.bProcessing && e(t.aanFeatures.r).css('display', a ? 'block' : 'none'),
  ...
  function Je(t) {
    ...
    (t.scrollBarVis = X),
      ...
      T && ((j = T.clone().prependTo(D)), (F = T.find('tr')), (P = j.find('tr'))),
      ...
      '' === n
        ? ((w.width = '100%'),
          x &&
            (D.find('tbody').height() > h.offsetHeight || 'scroll' == p.css('overflow-y')) &&
      ...
      D.outerWidth() < U
        ? ((E = h.scrollHeight > h.offsetHeight || 'scroll' == p.css('overflow-y') ? U + o : U),
          x &&
  ...
  function $e(a) {
    ...
    if (y || (!p && !o && !l && u == E(a) && u == c.length))
      ...
      for (
        ...
        (g = n[f[v]]),
          (c[v].style.width = null !== g.sWidthOrig && '' !== g.sWidthOrig ? Ke(g.sWidthOrig) : ''),
          g.sWidthOrig &&
            o &&
            e(c[v]).append(
              e('<div/>').css({
  ...
  function et(t) {
    ...
    for (
      e.isArray(v) && m(v), g && v.pre && m(v.pre), m(t.aaSorting), g && v.post && m(v.post), a = 0;
      a < b.length;
      a++
    )
  ...
  function at(e) {
    for (
      var t, a, r = e.aoColumns, n = et(e), i = e.oLanguage.oAria, l = 0, o = r.length;
      o > l;
      l++
    ) {
      var s = r[l],
      ...
      c.removeAttribute('aria-sort'),
        s.bSortable
          ? (n.length > 0 && n[0].col == l
              ? (c.setAttribute('aria-sort', 'asc' == n[0].dir ? 'ascending' : 'descending'),
                (a = u[n[0].index + 1] || u[0]))
              : (a = u[0]),
  ...
  function lt(e, t) {
    ...
    for (var l, o, s = n.ext.type.order[a.sType + '-pre'], u = 0, f = e.aoData.length; f > u; u++)
      (l = e.aoData[u]),
        l._aSortData || (l._aSortData = []),
        (!l._aSortData[t] || r) &&
          ((o = r ? i[u] : z(e, u, t, 'sort')), (l._aSortData[t] = s ? s(o) : o));
  }
  function ot(t) {
    ...
    var i,
      ...
      s = function(a) {
        ...
        if (
          ...
          a.start !== r && ((t._iDisplayStart = a.start), (t.iInitDisplayStart = a.start)),
  ...
  function ft(e, a, r, i) {
    if (
      ...
      i &&
        (r += '. For more information about this error, please see http://datatables.net/tn/' + i),
      a)
    )
  ...
  function Ut(e, t) {
    ...
    return (
      r >= t
        ...
        : e >= t - 1 - n
        ? ((a = w(t - (r - 2), t)), a.splice(0, 0, 'ellipsis'), a.splice(0, 0, 0))
        : ((a = w(e - n + 2, e + n - 1)),
          a.push('ellipsis'),
          a.push(t - 1),
      ...
      return (
        this.each(function() {
          ...
          if ('table' != this.nodeName.toLowerCase())
            return void ft(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
          ...
          if (
            ...
            w.iInitDisplayStart === r &&
              ((w.iInitDisplayStart = l.iDisplayStart), (w._iDisplayStart = l.iDisplayStart)),
          ...
          e.extend(!0, x, l.oLanguage),
            x.sUrl &&
              ...
              (g = !0)),
            null === l.asStripeClasses && (w.asStripeClasses = [T.sStripeOdd, T.sStripeEven]);
            ...
            E = function() {
              ...
              if (
                ...
                0 === o.length || 0 === o.children().length
                  ...
                  : o.length > 0 && ((w.nTFoot = o[0]), pe(w.aoFooter, w.nTFoot)),
                l.aaData)
              )
          ...
          l.bStateSave
            ? ((B.bStateSave = !0), pt(w, 'aoDrawCallback', ot, 'state_save'), st(w, l, E))
            : E();
        }),
        (a = null),
        this
    ...
    e.extend(l.prototype, {
      ...
      iterator: function(e, t, a, n) {
        var o,
          ...
          g = this.selector;
        for (
          'string' == typeof e && ((n = a), (a = t), (t = e), (e = !1)), s = 0, u = d.length;
          u > s;
          s++
        ) {
          var b = new l(d[s]);
          if ('table' === t) (o = a.call(b, d[s], s)), o !== r && i.push(o);
            ...
            for (
              p = this[s], 'column-rows' === t && (h = It(d[s], g.opts)), f = 0, c = p.length;
              c > f;
              f++
            )
              (v = p[f]),
      ...
      map: function(e) {
        ...
        else for (var a = 0, r = this.length; r > a; a++) t.push(e.call(this, this[a], a));
        return new l(this.context, t);
      },
      pluck: function(e) {
    ...
    (l.extend = function(t, a, r) {
      if (r.length && a && (a instanceof l || a.__dt_wrapper)) {
        ...
        for (n = 0, i = r.length; i > n; n++)
          (u = r[n]),
            (a[u.name] =
              'function' == typeof u.val ? c(t, u.val, u) : e.isPlainObject(u.val) ? {} : u.val),
            (a[u.name].__dt_wrapper = !0),
            l.extend(t, a[u.name], u.propExt);
      }
    }),
    (l.register = o = function(t, a) {
      if (e.isArray(t)) for (var r = 0, n = t.length; n > r; r++) l.register(t[r], a);
      else {
        var i,
          o,
          f,
        ...
        for (i = 0, o = s.length; o > i; i++) {
          ...
          var h = d(u, f);
          h || ((h = { name: f, val: {}, methodExt: [], propExt: [] }), u.push(h)),
  ...
  o('tables()', function(e) {
    ...
    o('draw()', function(e) {
      return this.iterator('table', function(t) {
        'page' === e
          ? ce(t)
          : ('string' == typeof e && (e = 'full-hold' === e ? !1 : !0), de(t, e === !1));
      });
    }),
    o('page()', function(e) {
      return e === r
  ...
  o('ajax.json()', function() {
    ...
    o('ajax.url()', function(t) {
      ...
      return t === r
        ? 0 === a.length
          ? r
          : ((a = a[0]), a.ajax ? (e.isPlainObject(a.ajax) ? a.ajax.url : a.ajax) : a.sAjaxSource)
  ...
  var Tt = function(t, a, n, l, o) {
      var u,
        ...
        v = typeof a;
      for (
        (a && 'string' !== v && 'function' !== v && a.length !== r) || (a = [a]),
          c = 0,
          d = a.length;
        d > c;
        c++
        ...
        for (
          f = a[c] && a[c].split && !a[c].match(/[\[\(:]/) ? a[c].split(',') : [a[c]],
            h = 0,
            p = f.length;
          p > h;
          h++
    ...
    It = function(t, a) {
      ...
      if ('current' == c) for (r = t._iDisplayStart, n = t.fnDisplayEnd(); n > r; r++) l.push(o[r]);
        ...
        for (r = 0, n = t.aoData.length; n > r; r++)
          'none' == u
            ? l.push(r)
            : ((i = e.inArray(r, o)),
              ((-1 === i && 'removed' == u) || (i >= 0 && 'applied' == u)) && l.push(r));
      return l;
    },
    At = function(t, a, n) {
      var i,
      ...
      return (
        this.iterator('row', function(t, a, n) {
          ...
          for (i.splice(a, 1), o = 0, s = i.length; s > o; o++)
            if (
              ((c = i[o]), (d = c.anCells), null !== c.nTr && (c.nTr._DT_RowIndex = o), null !== d)
            )
  ...
  var Ft = function(t, a, r, n) {
      var i = [],
        l = function(a, r) {
          if (e.isArray(a) || a instanceof e) for (var n = 0, o = a.length; o > n; n++) l(a[n], r);
          else if (a.nodeName && 'tr' === a.nodeName.toLowerCase()) i.push(a);
          else {
            var s = e('<tr><td/></tr>').addClass(r);
            (e('td', s)
              .addClass(r)
              .html(a)[0].colSpan = E(t)),
              i.push(s[0]);
          }
        };
      l(r, n),
    ...
    Pt = function(e, t) {
      ...
      if (a.length && e.length) {
        ...
        r._details &&
          ((r._detailsShow = t), t ? r._details.insertAfter(r.nTr) : r._details.detach(), Rt(a[0]));
      }
    },
    Rt = function(e) {
      var t = new l(e),
      ...
      b = function(a) {
        ...
        if (null === a || a === r || n) {
          for (c = [], d = 0, h = l.length; h > d; d++)
            for (u = l[d], p = 0; f > p; p++)
              (v = { row: u, column: p }),
                n
                  ? ((g = i[u]), a(v, z(t, u, p), g.anCells ? g.anCells[p] : null) && c.push(v))
                  : c.push(v);
          return c;
        }
        if (e.isPlainObject(a))
          return a.column !== r && a.row !== r && -1 !== e.inArray(a.row, l) ? [a] : [];
        var o = s
          .filter(a)
          .map(function(e, t) {
        ...
        return o.length || !a.nodeName
          ...
          : ((g = e(a).closest('*[data-dt-row]')),
            g.length ? [{ row: g.data('dt-row'), column: g.data('dt-column') }] : []);
      };
    return Tt('cell', a, b, t, n);
  };
  o('cells()', function(t, a, n) {
    if (
      (e.isPlainObject(t) && (t.row === r ? ((n = t), (t = null)) : ((n = a), (a = null))),
    ...
    o('cell().data()', function(e) {
      ...
      return e === r
        ? t.length && a.length
          ...
          : r
        : (Y(t[0], a[0].row, a[0].column, e), ie(t[0], a[0].row, 'data', a[0].column), this);
    }),
    o('order()', function(t, a) {
      ...
      return t === r
        ...
        : ('number' == typeof t
            ? (t = [[t, a]])
            : t.length && !e.isArray(t[0]) && (t = Array.prototype.slice.call(arguments)),
          this.iterator('table', function(e) {
            e.aaSorting = t.slice();
          }));
    }),
        ...
        this.iterator('table', function(r) {
          ...
          (r.bDestroying = !0),
            ...
            e('th, td', f).removeClass(
              o.sSortable + ' ' + o.sSortableAsc + ' ' + o.sSortableDesc + ' ' + o.sSortableNone
            ),
            h.children().detach(),
            h.append(v);
      ...
      header: {
        _: function(t, a, r, n) {
          e(t.nTable).on('order.dt.DT', function(e, i, l, o) {
            if (t === i) {
              var s = r.idx;
              a.removeClass(r.sSortingClass + ' ' + n.sSortAsc + ' ' + n.sSortDesc).addClass(
                'asc' == o[s] ? n.sSortAsc : 'desc' == o[s] ? n.sSortDesc : r.sSortingClass
              );
            }
          });
        },
