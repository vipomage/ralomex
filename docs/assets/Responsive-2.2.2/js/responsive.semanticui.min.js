...
(function(c) {
  'function' === typeof define && define.amd
    ? define(['jquery', 'datatables.net-se', 'datatables.net-responsive'], function(a) {
        return c(a, window, document);
      })
    : 'object' === typeof exports
    ? (module.exports = function(a, b) {
        a || (a = window);
        if (!b || !b.fn.dataTable) b = require('datatables.net-se')(a, b).$;
        ...
        ? e ||
          (a &&
            ...
            d
              .find('div.header')
              .empty()
              .append('<h4 class="title">' + a.header(b) + '</h4>'),
          d
            .find('div.content')
            .empty()
            .append(f()),
          d.appendTo('body').modal('show'))
        : g(b, e, f);
    };
  };
  return a.Responsive;
